const translations = {
    'es': {
        ...
        'transcriptions': 'Transcripciones musicales por encargo',
    ...
    'en': {
        ...
        'transcriptions': 'Musical Transcriptions<br>on demand',
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM loaded, setting default language');
    changeLanguage('es');
});
